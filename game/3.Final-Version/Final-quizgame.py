...
Fragen = [{'Frage': 'Was ist die Hauptstadt von Frankreich?', 'Antwort': 'Paris', 'Zur Auswahl stehen': ['Paris', 'London', 'Berlin']}, 
          ...
          {'Frage': 'Was ist die kleinste Primzahl?', 'Antwort': '2', 'Zur Auswahl stehen': ['1', '2', '3']}, 
          {'Frage': "Welches Element hat das chemische Symbol 'O'?", 'Antwort': 'Sauerstoff', 'Zur Auswahl stehen': ['Gold', 'Sauerstoff', 'Silber']}, 
          {'Frage': "Wer schrieb 'Faust'?", 'Antwort': 'Goethe', 'Zur Auswahl stehen': ['Schiller', 'Goethe', 'Lessing']}, 
          {'Frage': 'Wie viele Kontinente gibt es?', 'Antwort': '7', 'Zur Auswahl stehen': ['5', '6', '7']}, 
          {'Frage': 'Welches Tier ist das Wappentier der Vereinigten Staaten?', 'Antwort': 'Weißkopfseeadler', 'Zur Auswahl stehen': ['Weißkopfseeadler', 'Grizzlybär', 'Capybara']}
]
